        ...
        <div className="bg-white rounded-2xl p-8 shadow-xl">
          ...
          {success ? (
            <div role="alert" className="p-4 bg-green-50 border border-green-200 text-green-700 rounded-lg text-sm text-center">
              ...
              <p className="mt-1 text-green-600">Redirecting to sign in…</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    spellCheck={false}
                    placeholder="••••••••"
                    className="w-full pl-12 pr-4 py-3 rounded-lg border-2 border-gray-300 focus:border-[#FAA21B] focus:ring-2 focus:ring-[#FAA21B]/20 focus-visible:outline-none transition-all"
                  />
                </div>
              </div>

              <div>
                <label htmlFor="confirm" className="block text-sm font-medium text-[#112B4F] mb-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full px-6 py-4 bg-[#FAA21B] text-[#112B4F] rounded-full font-bold hover:bg-[#FAA21B]/90 transition-colors shadow-lg disabled:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FAA21B] focus-visible:ring-offset-2"
              >
