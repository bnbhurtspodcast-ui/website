...
import { updateSponsorshipStatus, reviewSponsorshipInquiry, deleteSponsorshipInquiry } from '@/app/(admin)/admin/sponsorships/actions'
    ...
    <div>
      ...
      <div className="grid grid-cols-4 gap-3 mb-6">
        <div className="admin-card p-3 md:p-4 border-l-2 border-l-white/20">
          <div className="text-xl md:text-2xl font-black text-white">{sponsorships.length}</div>
        ...
        <div className="admin-card p-3 md:p-4 border-l-2 border-l-violet-400/70">
          <div className="text-xl md:text-2xl font-black text-violet-400">
            {sponsorships.filter((s) => s.status === 'negotiating').length}
          </div>
          <div className="text-[9px] md:text-xs text-white/40 uppercase tracking-wide mt-0.5">Negotiating</div>
        </div>
