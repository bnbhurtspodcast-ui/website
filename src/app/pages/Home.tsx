...
export function Home() {
  const { setCurrentEpisode } = useOutletContext<{
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center">
            ...
            <p className="text-xl text-[#112B4F] font-medium mb-8 max-w-2xl mx-auto">
              Real talk about life's aches, pains, and
              everything in between. No filters, just honest
              conversations.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <div className="text-[#FAA21B] font-medium">
                Episodes Published
              </div>
            </div>
            <div className="text-center">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12">
            <div>
              ...
              <p className="text-[#FAA21B] font-medium">
                Our most popular and thought-provoking
                conversations
              </p>
            </div>
            <Link
      ...
      <section id="subscribe" className="py-20 bg-[#FAA21B]">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[#112B4F]/80 text-lg mb-8 font-medium">
            Subscribe to Back n' Body Hurts on your favorite
            podcast platform
          </p>
