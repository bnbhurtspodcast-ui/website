      ...
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3">
            <img src={logo} alt="Back n' Body Hurts Podcast" className="h-14 w-14" />
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button className="px-5 py-2.5 rounded-full bg-[#FAA21B] text-[#112B4F] font-bold hover:bg-[#FAA21B]/90 transition-all shadow-lg">
              Subscribe
            </button>
            <Link
              to="/admin/signin"
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-[#FAA21B]/20">
            <div className="flex flex-col gap-4">
              ...
              <button className="mx-4 px-4 py-2 rounded-full bg-[#FAA21B] text-[#112B4F] font-bold">
                Subscribe
              </button>
            </div>
          </div>
